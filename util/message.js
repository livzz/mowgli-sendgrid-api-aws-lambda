class Message {
    ...
    constructor(request){
        this.msgToClient = {
            to: request.to,
            from: "dont-reply@droidvue.com", // TODO: Change domain name
    ...
    getMessageForClient(){
        switch (this.request.type){
            ...
            case "0":
                ...
                this.msgToClient.templateId = "a09e0e42-eab7-4141-9142-3d6e1e2ff3fe"; // TODO: update Template ID
    ...
    getMessageForOwner(){
        switch (this.request.type){
            ...
            case "0":
                ...
                this.msgToOwner.templateId = "566dbd06-2a9c-4668-813c-4aa12d52f465"; // TODO: update Template ID
